...
export default function DownloadSection() {
    ...
    downloadOptions.forEach((opt, i) => opt.icon = icons[i]);

    return (
        <Container name="download">
            <div className="text-center max-w-3xl mx-auto">
                <h2 className="text-4xl md:text-5xl font-bold mb-6">
                    <Trans i18nKey="downloadSection.heading" components={{ 1: <span className="bg-gradient-to-r from-primary-400 via-primary-700 via-80% to-primary-900 bg-clip-text text-transparent font-semibold" /> }} />
                </h2>
                ...
                {downloadOptions.map((option, index) => (
                    <Card key={index} className="hover:shadow-xl hover:-translate-y-2 group">
                        <div className="p-8">
                            ...
                            <Button as="a" href={option.url} className="w-full gap-2 hover:shadow-xl bg-gradient-to-r from-primary-500 via-green-500 to-green-400" size="lg">
