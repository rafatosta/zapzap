"""
Pacote zapzap.infrastructure.notifications.freedesktop

Responsabilidade:
    Marca o diretório como pacote Python na arquitetura ideal e centraliza exports públicos quando necessário.
