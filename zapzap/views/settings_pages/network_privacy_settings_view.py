...
from zapzap.views.settings_components import SettingsActionRow
...
from zapzap.views.settings_components import SettingsPasswordRow
...
from zapzap.views.settings_components import SettingsTextRow
...
class NetworkPrivacySettingsView(SettingsPage):
    ...
    def _setup_proxy_section(self):
        ...
        self.proxyDescription = Label("", "row_description")
