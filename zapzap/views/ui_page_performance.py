...
class Ui_PagePerformance(object):
    def setupUi(self, PagePerformance):
        ...
        self.force_gbm = QtWidgets.QCheckBox(parent=self.group_gpu)
        self.force_gbm.setObjectName("force_gbm")
        self.vboxlayout.addWidget(self.force_gbm)
        self.disable_accessibility = QtWidgets.QCheckBox(parent=self.group_gpu)
        self.disable_accessibility.setObjectName("disable_accessibility")
        self.vboxlayout.addWidget(self.disable_accessibility)
    ...
    def retranslateUi(self, PagePerformance):
        ...
        self.force_gbm.setText(_("Force GBM on Wayland (Fixes NVIDIA lag)"))
        self.disable_accessibility.setText(_("Disable Accessibility (Fixes typing lag)"))
