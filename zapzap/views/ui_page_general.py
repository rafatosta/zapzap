...
class Ui_PageGeneral(object):
    def setupUi(self, PageGeneral):
        ...
        self.groupBox_debug_logs = QtWidgets.QGroupBox(parent=self.frame)
        self.groupBox_debug_logs.setObjectName("groupBox_debug_logs")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.groupBox_debug_logs)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.debug_logs_path = QtWidgets.QLineEdit(parent=self.groupBox_debug_logs)
        self.debug_logs_path.setReadOnly(True)
        self.debug_logs_path.setObjectName("debug_logs_path")
        self.verticalLayout_4.addWidget(self.debug_logs_path)
        self.label_debug_logs_hint = QtWidgets.QLabel(parent=self.groupBox_debug_logs)
        self.label_debug_logs_hint.setWordWrap(True)
        self.label_debug_logs_hint.setObjectName("label_debug_logs_hint")
        self.verticalLayout_4.addWidget(self.label_debug_logs_hint)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.btn_open_debug_logs = QtWidgets.QPushButton(parent=self.groupBox_debug_logs)
        self.btn_open_debug_logs.setObjectName("btn_open_debug_logs")
        self.horizontalLayout_2.addWidget(self.btn_open_debug_logs)
        self.btn_delete_old_debug_logs = QtWidgets.QPushButton(parent=self.groupBox_debug_logs)
        self.btn_delete_old_debug_logs.setObjectName("btn_delete_old_debug_logs")
        self.horizontalLayout_2.addWidget(self.btn_delete_old_debug_logs)
        self.btn_delete_all_debug_logs = QtWidgets.QPushButton(parent=self.groupBox_debug_logs)
    ...
    def retranslateUi(self, PageGeneral):
        ...
        self.groupBox_debug_logs.setTitle(_("Debug logs"))
        self.label_debug_logs_hint.setText(_("Crash reports are stored in this folder. You can open the directory or clean old files."))
