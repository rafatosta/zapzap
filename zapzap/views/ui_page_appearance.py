...
class Ui_PageAppearance(object):
    ...
    def retranslateUi(self, PageAppearance):
        ...
        self.label.setText(_translate("PageAppearance", "Aparência"))
        self.style_groupBox.setTitle(_translate("PageAppearance", "Estilo"))
        self.theme_auto_radioButton.setText(_translate("PageAppearance", "Adaptativo"))
        self.theme_light_radioButton.setText(_translate("PageAppearance", "Claro"))
        self.theme_dark_radioButton.setText(_translate("PageAppearance", "Escuro"))
        self.tray_groupBox.setTitle(_translate("PageAppearance", "Ícone da bandeja"))
        self.tray_default_radioButton.setText(_translate("PageAppearance", "Padrão"))
        self.tray_slight_radioButton.setText(_translate("PageAppearance", "Simbólico Claro"))
        self.tray_sdark_radioButton.setText(_translate("PageAppearance", "Simbólico Escuro"))
        self.browser_sidebar.setText(_translate("PageAppearance", "Mostrar barra lateral"))
        self.mainwindow_menu.setText(_translate("PageAppearance", "Mostrar barra de menu"))
        self.scaleLabel.setText(_translate("PageAppearance", "Escala"))
        ...
        self.label_2.setText(_translate("PageAppearance", "Nota: Algumas mudanças só terão efeito até reiniciar."))
