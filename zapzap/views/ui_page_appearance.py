...
class Ui_PageAppearance(object):
    def setupUi(self, PageAppearance):
        ...
        self.theme_custom_radioButton = QtWidgets.QRadioButton(parent=self.style_groupBox)
        self.theme_custom_radioButton.setObjectName("theme_custom_radioButton")
        self.gridLayout.addWidget(self.theme_custom_radioButton, 0, 3, 1, 1)
        self.verticalLayout_2.addWidget(self.style_groupBox)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.custom_color_1 = QtWidgets.QLineEdit(parent=self.frame)
        self.custom_color_1.setObjectName("custom_color_1")
        self.horizontalLayout_2.addWidget(self.custom_color_1)
        self.custom_color_2 = QtWidgets.QLineEdit(parent=self.frame)
        self.custom_color_2.setObjectName("custom_color_2")
        self.horizontalLayout_2.addWidget(self.custom_color_2)
        self.custom_color_3 = QtWidgets.QLineEdit(parent=self.frame)
        self.custom_color_3.setObjectName("custom_color_3")
        self.horizontalLayout_2.addWidget(self.custom_color_3)
        self.custom_color_4 = QtWidgets.QLineEdit(parent=self.frame)
        self.custom_color_4.setObjectName("custom_color_4")
        self.horizontalLayout_2.addWidget(self.custom_color_4)
    ...
    def retranslateUi(self, PageAppearance):
        ...
        self.theme_custom_radioButton.setText(_("Custom"))
