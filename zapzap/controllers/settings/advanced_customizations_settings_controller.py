...
from zapzap.models.settings.advanced_customizations_settings_model import (
    AdvancedCustomizationsSettingsModel,
)
...
from zapzap.views.settings_pages.advanced_customizations_settings_view import (
