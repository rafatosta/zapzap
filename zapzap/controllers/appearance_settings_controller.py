...
from zapzap.models.appearance_settings_model import AppearanceSettingsModel
from zapzap.resources.TrayIcon import TrayIcon
from zapzap.services.ThemeManager import ThemeManager
from zapzap.views.pages.appearance_settings_view import AppearanceSettingsView
...
class AppearanceSettingsController(AppearanceSettingsView):
    ...
    def _load_settings(self):
        ...
        self.notificationCounter.setChecked(self.model.notification_counter_enabled)
        ...
        self.csr_direction_comboBox.setCurrentText(self.model.csr_buttons_direction)
    ...
    def _load_csr_button_themes(self):
        ...
        self.csr_theme_comboBox.addItems(self.model.available_csr_button_themes())
        theme_index = self.csr_theme_comboBox.findText(self.model.csr_button_theme)
    ...
    def _connect_signals(self):
        ...
        self.notificationCounter.clicked.connect(self._handle_notification_counter)
