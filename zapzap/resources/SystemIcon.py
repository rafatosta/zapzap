...
class SystemIcon:
    ...
    SVG_ICONS = {
        ...
        "donation": (
            """
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="{fill_color}" viewBox="0 0 256 256">
                <path d="M230.33,141.06a24.43,24.43,0,0,0-34.54,0L128,208.87,60.21,141.06a24.43,24.43,0,0,0-34.54,0h0a24.45,24.45,0,0,0,0,34.54l85,85a24,24,0,0,0,34,0l85-85A24.45,24.45,0,0,0,230.33,141.06ZM128,50a58,58,0,1,1-58,58A58.07,58.07,0,0,1,128,50Zm0,100a42,42,0,1,0-42-42A42,42,0,0,0,128,150Z"></path>
            </svg>
            """
        ),
    }
