...
class Ui_Advanced(object):
    def setupUi(self, Advanced):
        ...
        self.notificationCounter = QtWidgets.QCheckBox(parent=Advanced)
        self.notificationCounter.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        self.notificationCounter.setChecked(True)
        self.notificationCounter.setObjectName("notificationCounter")
        self.gridLayout_2.addWidget(self.notificationCounter, 3, 1, 1, 1)
    ...
    def retranslateUi(self, Advanced):
        ...
        self.label_6.setText(_("Notification counter in tray"))
        self.notificationCounter.setText(_("On"))
