...
class Ui_General(object):
    def setupUi(self, General):
        ...
        self.label_startBackground = QtWidgets.QLabel(parent=self.general_scrollArea)
        self.label_startBackground.setObjectName("label_startBackground")
        self.gridLayout_win.addWidget(self.label_startBackground, 1, 0, 1, 1)
        self.startBackground = QtWidgets.QCheckBox(parent=self.general_scrollArea)
        self.startBackground.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        self.startBackground.setObjectName("startBackground")
        self.gridLayout_win.addWidget(self.startBackground, 1, 1, 1, 1)
        self.labelWayland = QtWidgets.QLabel(parent=self.general_scrollArea)
        self.labelWayland.setObjectName("labelWayland")
        self.gridLayout_win.addWidget(self.labelWayland, 2, 0, 1, 1)
        ...
        self.gridLayout_win.addWidget(self.wayland, 2, 1, 1, 1)
    ...
    def retranslateUi(self, General):
        ...
        self.label_startBackground.setText(_("Start minimized"))
        self.startBackground.setText(_("Off"))
