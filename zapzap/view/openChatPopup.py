...
# Form implementation generated from reading ui file './zapzap/view/openChatPopup.ui'
#
...
class Ui_OpenChatPopup(object):
    def setupUi(self, OpenChatPopup):
        ...
        self.popupMargins = QtWidgets.QFrame(OpenChatPopup)
        ...
        self.popupFrame = QtWidgets.QFrame(self.popupMargins)
        ...
        self.label_4 = QtWidgets.QLabel(self.popupFrame)
        font = QtGui.QFont()
        ...
        self.label = QtWidgets.QLabel(self.popupFrame)
        ...
        self.btnCancel = QtWidgets.QPushButton(self.popupFrame)
