...
DISABLE = """<path d="M 150.063 90.451 H 182.371 V 150.128 H 246.989 V 179.967 H 182.371 V 239.645 H 150.063 V 179.967 H 85.445 V 150.128 H 150.063 Z" style="fill: rgb(255, 0, 0); stroke: rgb(0, 0, 0);" transform="matrix(0.715986, -0.698115, 0.698115, 0.715986, -68.014503, 162.914597)" bx:shape="cross 85.445 90.451 161.544 149.194 29.839 32.308 0.5 1@64eb8597"/>"""

ICON_DISABLE = ICON_DEFAULT.format(DISABLE)
